...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("factory", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("factory", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "factory";
		app.meta["name"] = "cake factory";
		...
		#elseif air
		app.window.title = "cake factory";
		#else
		app.window.context.attributes.background = 986895;
