...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("factory",ca,1c,d8,a7),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("111",51,59,25,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("factory",ca,1c,d8,a7));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("cake factory",62,f0,d2,a7));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("cake factory",62,f0,d2,a7))
...
HXLINE(  69)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),986895)
