...
class HXCPP_CLASS_ATTRIBUTES AssetPaths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String exclamationBadge__png;
		static ::String shopItemBox__png;
		static ::String rollingPin__png;
		static ::String arrow__png;
		static ::String jerryCoin__png;
		static ::String strawberry__png;
		static ::String testTab__png;
